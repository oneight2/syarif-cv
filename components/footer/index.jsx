...
function Footer() {
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content rounded-xl font-outfit mb-24 lg:mb-10">
            <div className="items-center grid-flow-col">
                ...
                <p>{`Copyright © ${new Date().getFullYear()}  - Syarif Hidayat`}</p>
            </div>
